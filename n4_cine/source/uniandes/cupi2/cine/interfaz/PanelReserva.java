...
public class PanelReserva extends JPanel implements ActionListener
{
    ...
    public PanelReserva( InterfazCine laVentana, Cine elCine )
    {
        ...
        GridBagConstraints posicion = new GridBagConstraints( 0, 0, 1, 1, 0, 0, 
        ...
        posicion = new GridBagConstraints( 0, 0, 2, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( etiquetaSeleccionarSilla, posicion );

        posicion = new GridBagConstraints( 0, 1, 2, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( cboTipoSilla, posicion );

        posicion = new GridBagConstraints( 0, 3, 2, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( cboFila, posicion );

        posicion = new GridBagConstraints( 0, 5, 2, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( cboNumero, posicion );

        posicion = new GridBagConstraints( 2, 7, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( btnAgregarSilla, posicion );

        posicion = new GridBagConstraints( 2, 0, 2, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( etiquetaSillasReservadas, posicion );

        posicion = new GridBagConstraints( 2, 1, 2, 6, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelSillas.add( scrollLista, posicion );

        posicion = new GridBagConstraints( 0, 1, 1, 4, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        ...
        posicion = new GridBagConstraints( 0, 8, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelReserva.add( btnCancelar, posicion );

        posicion = new GridBagConstraints( 1, 8, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelReserva.add( btnGuardar, posicion );

        posicion = new GridBagConstraints( 2, 8, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        panelReserva.add( btnCargar, posicion );

        posicion = new GridBagConstraints( 0, 5, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.CENTER, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
        ...
        posicion = new GridBagConstraints( 0, 6, 1, 1, 0, 0, 
        		GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, 
        		new Insets( 3, 3, 3, 3 ), 0, 0 );
    ...
    public void repintar( Reserva reservaActual )
    {
        ...
        for( int i = 0; i < sillas.size( ); i++ )
        {
            ...
            listaSillas[ i ] = Character.toString( silla.darFila( ) ) + 
            		Integer.toString( silla.darNumero( ) );
        }
        ...
        //Total dinero
        etiquetaDinero.setText( "Total Dinero en la caja: $" + 
        		cine.darTotalDinero( ) );
    }
    ...
    private void recargarSillas( )
    {
        try
        {
            ...
            {
                char fila = ( ( Character )cboFila.getSelectedItem( ) ).
                		charValue( );
        ...
        {
            JOptionPane.showMessageDialog( this, "Error al cargar las sillas: " 
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        else if( AGREGAR.equals( comando ) )
        {
            try
            {
                char fila = ( ( Character )cboFila.getSelectedItem( ) ).
                		charValue( );
                int numero = ( ( Integer )cboNumero.getSelectedItem( ) ).
                		intValue( );
            ...
            catch( Exception e2 )
            {
                JOptionPane.showMessageDialog( this, 
                		"Debe seleccionar una silla válida.", "Error", 
